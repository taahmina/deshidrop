...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 14, 2025 at 06:18 AM
...
--
-- Table structure for table `delivary_people`
--

CREATE TABLE `delivary_people` (
  `id` bigint(20) UNSIGNED NOT NULL,
  ...
  `status` enum('available','busy','inactive','assigned') NOT NULL DEFAULT 'available',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(14, '4', NULL, 840.00, NULL, 30.00, NULL, '810', '8', '1', 'processing', NULL, NULL, 'Please delivar  it as soon as possible', '2no gate,Chattogram', '2025-09-27 22:38:50', '2025-10-08 00:40:46', '2', 5, NULL, NULL),
...
(17, '7', NULL, 200.00, NULL, 0.00, NULL, '200', '1', '1', 'pending', NULL, NULL, 'wgesdjnc', 'sagsdfj', '2025-10-05 21:16:28', '2025-10-05 21:16:28', NULL, NULL, NULL, NULL),
(18, '7', NULL, 200.00, NULL, 0.00, NULL, '200', '1', '1', 'pending', NULL, NULL, 'wgesdjnc', 'sagsdfj', '2025-10-05 21:26:45', '2025-10-05 21:26:45', NULL, NULL, NULL, NULL);
...
--
-- Indexes for table `delivary_people`
--
ALTER TABLE `delivary_people`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `delivary_people_phone_unique` (`phone`),
  ADD UNIQUE KEY `delivary_people_email_unique` (`email`);
...
--
-- AUTO_INCREMENT for table `delivary_people`
--
ALTER TABLE `delivary_people`
