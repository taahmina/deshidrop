        ...
        <section>
            <div class="block">
                ...
                <div class="restaurant-searching text-center">
                    <div class="restaurant-searching-inner">
                        ...
                        <div class="funfacts">
                                <div class="col-md-3 col-sm-6 col-lg-3">
                                    <div class="fact-box">
                                        <i class="brd-rd50"><img src="{{asset('assets/images/resource/fact-icon1.png')}}" alt="fact-icon1" itemprop="image"></i>
                                ...
                                <div class="col-md-3 col-sm-6 col-lg-3">
                                    <div class="fact-box">
                                        <i class="brd-rd50"><img src="{{asset('assets/images/resource/fact-icon2.png')}}" alt="fact-icon2" itemprop="image"></i>
                                        <div class="fact-inner">
                                ...
                                <div class="col-md-3 col-sm-6 col-lg-3">
                                    <div class="fact-box">
                                        <i class="brd-rd50"><img src="{{asset('assets/images/resource/fact-icon3.png')}}" alt="fact-icon3" itemprop="image"></i>
                                        <div class="fact-inner">
                                ...
                                <div class="col-md-3 col-sm-6 col-lg-3">
                                    <div class="fact-box">
                                        <i class="brd-rd50"><img src="{{asset('assets/images/resource/fact-icon4.png')}}" alt="fact-icon4" itemprop="image"></i>
                                        <div class="fact-inner">
                    ...
                    <img class="left-scooty-mockup" src="{{asset('assets/images/resource/restaurant-mockup1.png')}}" alt="restaurant-mockup1.png" itemprop="image">
                    <img class="bottom-clouds-mockup" src="{{asset('assets/images/resource/clouds.png')}}" alt="clouds.png" itemprop="image">
